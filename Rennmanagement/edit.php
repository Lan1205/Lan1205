            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="./rennmanagement.php">Zurück</a></li>
                        ...
                        <form action="rennlogik.php" method="post">
                                    <div  class="card-header">
                                        ...
                                        $db = new Database();
                                                    ...
                                                    {
                                                        echo $result['standort'].", ". $result['datum'];
                                                    }
                                        ?>
                                    </div>
                                        <div class="card-body ">
                                            ...
                                            <form action="" method="post">
                                                <div class="row gy-2 mt-1">
                                                    <div class=" col-auto ">
                                                        <input type="text" id="mischung" name="mischung" placeholder="Mischung" required>
                                                    </div>
                                                    <div class=" col-auto ">
                                                        <input  type="text" id="bezeichnung" name="bezeichnung" placeholder="Bezeichnung" required>
                                                    </div>
                                                    <div class=" col-auto ">
                                                        <input type="text" id="kontingent" name="kontingent" placeholder="Kontingent" required>
                                                    </div>
                                                    <div class=" col-auto mt-1">
                                                        <button type="submit" name="hinzufügen"  id="add"  class="btn btn-dark" >Mischung hinzufügen</button>
                                                    </div>
                                                </div>
                                            </form>
                                            </div>
                                                    ...
                                                    <table id="datatablesSimple">
                                                        ...
                                                        $stmt->execute();
                                                            while($result = $stmt->fetch())
                                                            {
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                    <td><?php echo $result['mischung'];?></td>
                                                                        <td><?php echo $result['bezeichnung'];?></td>
                                                                        <td><?php echo $result['kontingent'];?></td>
                                                                    </tr>
                                                                </tbody>
                                                                </div>
                                                            <?php
